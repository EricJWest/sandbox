...
""" Create a movie of a rotating, checkered, 3d sphere  """

import numpy as np
from mayavi import mlab

def sphere(t, omega, r, theta, phi):
  x = r*np.sin(theta)*np.cos(phi + omega*t)
  y = r*np.sin(theta)*np.sin(phi + omega*t)
  z = r*np.cos(theta)
  return x, y, z
...
## sphere radius
radius = 2
## rotation rate (angular frequency)
angFreq = 0.5
## latitude lines
numberOfLatLines = 2
